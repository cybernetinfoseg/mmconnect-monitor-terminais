    ...
    <div className="min-h-screen bg-slate-900 text-white overflow-hidden">
      ...
      <div className="bg-red-900/50 sm:px-8 sm:py-4 transition-colors duration-500">
        ...
        <div className="flex items-center justify-between gap-2 sm:gap-4">
          <div className="mx-auto flex items-center gap-2 sm:gap-4 min-w-0">
            <div className={cn(
            ...
            {/* Live indicator */}
            <div className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-emerald-500/10 flex-shrink-0 hidden">
          ...
          <div className="flex items-center gap-1 sm:gap-3 flex-shrink-0">
            <Button
              variant="outline"
              size="sm"
              onClick={() => setShowFilters((v) => !v)} className="bg-white/10 text-white mx-auto my-1 px-2 text-xs font-medium rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border shadow-sm hover:text-accent-foreground border-white/20 h-8 sm:h-9 sm:px-3 sm:text-sm hover:bg-white/20">
