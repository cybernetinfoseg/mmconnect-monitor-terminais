...
import {
  ...
  Wifi, WifiOff, RotateCcw, Monitor } from
'lucide-react';
...
export default function ControloAcesso() {
  ...
  return (
    ...
    {/* Mudamos max-w-7xl para max-w-full e aumentamos levemente o padding horizontal para respirar nas bordas */}
    <div className="w-full max-w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr_1fr] gap-5">
          ...
          <>
              ...
              <div className="hidden lg:block bg-white border rounded-xl space-y-4 border-slate-200 p-\xAB5">
