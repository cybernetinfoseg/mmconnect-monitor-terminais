    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-50 w-full overflow-x-hidden">
      <div className="w-full px-3 sm:px-6 py-4 sm:py-6 space-y-6 max-w-[1920px]">
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-slate-200/50">
          ...
          <CardContent className="pt-6 pr-2 pb-6 pl-6">
            <div className="space-y-3">
              <AnimatePresence mode="popLayout">
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -20 }}
                  transition={{ delay: index * 0.02 }} className="bg-emerald-50/50 pt-5 pr-5 pb-5 rounded-xl relative overflow-hidden border transition-all border-emerald-200">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-1">
                          <div className="rounded-sm flex items-center gap-2">
