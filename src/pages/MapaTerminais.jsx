...
import FloorPlanCanvasWrapper from '@/components/mapa/FloorPlanCanvasWrapper';
      ...
      <div className="w-full px-3 sm:px-6 py-4 sm:py-6 space-y-5 max-w-[1920px]">
        ...
        <div className="flex flex-col sm:flex-row gap-2 flex-wrap items-start sm:items-center">
          ...
          <select
            ...
            className="h-9 w-full sm:w-auto rounded-md border border-input bg-white px-3 py-1 text-sm shadow-sm focus:outline-none focus:ring-1 focus:ring-ring"
          >
