        ...
        <div className="max-w-full mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto">
            ...
            <Button
                ...
                disabled={isMonitoring} className="bg-white/10 text-white pr-6 pl-3 text-xs font-medium rounded-md inline-flex items-center justify-center whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border shadow-sm hover:text-accent-foreground h-8 border-white/20 hover:bg-white/20 gap-1.5">
